...
/// Text style factories — each takes an [AppColorScheme] so they adapt to any theme.
abstract final class AppTextStyles {

  // ─── Themed factories (take explicit scheme) ──────────────────────────────
  ...
  // ─── Convenience getters — use AppColors.current (active theme) ──────────

  static TextStyle get displayLargeCurrent  => displayLarge(AppColors.current);
  static TextStyle get displayMediumCurrent => displayMedium(AppColors.current);
  static TextStyle get headingLargeCurrent  => headingLarge(AppColors.current);
  static TextStyle get headingMediumCurrent => headingMedium(AppColors.current);
  static TextStyle get headingSmallCurrent  => headingSmall(AppColors.current);
